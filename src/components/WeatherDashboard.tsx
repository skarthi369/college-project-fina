...
const CITIES = [
  "Chennai", "Coimbatore", "Madurai", "Salem", "Tiruchirappalli", "Tirunelveli", "Vellore", "Erode", "Kanchipuram", "Thanjavur"
];

export const WeatherDashboard = () => {
  const [selectedCity, setSelectedCity] = useState(CITIES[0]);
  const { weatherData, loading, error, refreshWeather } = useWeatherAPI(undefined, undefined, selectedCity);
    ...
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-muted-foreground">
          Climate-smart farming insights for {selectedCity}
        </p>
      </div>
